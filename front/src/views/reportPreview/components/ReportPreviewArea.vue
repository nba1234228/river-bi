<template>
  <div class="report-preview-area">
    <div class="report-preview-area-content" :style="curStyle">
      <Layout
...
export default defineComponent({
  ...
  setup() {
    const {
      ...
      activityCompId,
      comps,
    } = storeData('reportPreview', '.report-preview-area-content');
